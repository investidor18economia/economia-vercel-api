...
function buildControlledEmailAnalyticsMetadata(context = {}, extras = {}) {
...
export function buildPriceAlertEmailAnalyticsPayload(input = {}) {
  ...
  return assembleAnalyticsInsertRow({
    event_name: input.eventName,
    session_id: context.sessionId ?? null,
    user_id: isAnalyticsUuid(alert.user_id) ? alert.user_id : null,
...
export function buildPriceAlertEmailTestAnalyticsPayload(input = {}) {
  ...
  const metadata = buildControlledEmailAnalyticsMetadata(context, {
