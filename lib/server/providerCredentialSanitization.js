...
export const PROVIDER_CREDENTIAL_SANITIZATION_VERSION = "05J.8";
...
const SAFE_DIAGNOSTIC_KEY_PATTERN =
  /^(errorcode|reasoncode|readiness|status|operation|providerid|environment|credentialtype|credentialversion|encryptionkeyversion|issuedat|expiresat|expiringsoon|persisted|configured|ok|message|nextstep|source|envfallbackactive|tokenpersistencestatus|accesstokenreceived|refreshtokenreceived|expiresinreceived|tokentypereceived|httpstatus|requestid|version|wrotefile|wrotedatabase|updatedenv|revoked|keyversion|refreshattempted|refreshsucceeded|refreshreasoncode|refreshoperation|credentialsource|accesstokenpresent|refreshperformed|refreshreason|authenticationcompleted|providerresponseclassification|budgetstate|cachehit|deduphit|credentialstatus|authheadersent|classification|latencyms|vaultonly|probeengineversion|mode|blockers|maxexternalcalls|circuitstate|resultcount|query|authorized|forbidlegacyenvtoken|probeenabled|vaultconfigured|externallcallrecorded|protectedfetchentered|executiontelemetry|httpstatustext|requesturl|universalcommercialcachehit|requestdeduplicated)$/i;

const SAFE_BOOLEAN_SUFFIX_PATTERN =
  /(Received|Configured|Present|Sent|Enabled|Valid|Known|Expired|WillBeSent|Active|Attempted|Succeeded)$/;
