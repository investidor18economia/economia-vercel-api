...
export const OFFICIAL_COMMERCIAL_ENV_FLAGS = Object.freeze([
  ...
  { name: "MERCADOLIVRE_OAUTH_TOKEN_PERSISTENCE_ENABLED", defaultValue: "true", purpose: "Vault OAuth ML", risk: "LOW" },
  { name: "PROVIDER_CREDENTIAL_VAULT_ENCRYPTION_KEY", defaultValue: "(secret)", purpose: "Vault encryption", risk: "secret" },
