...
import { instrumentSavingsEstimationAnalyticsFromOfferSet } from "./miaSavingsEstimationAnalytics.js";
import { instrumentAntiRegretFoundationFromOfferSet } from "./miaAntiRegretFoundationAnalytics.js";
...
export function instrumentOfferSetAnalyticsForDelivery(supabase, input = {}) {
  ...
  instrumentSavingsEstimationAnalyticsFromOfferSet(supabase, {
    requestId,
    analyticsContext: input.analyticsContext || bucket.analyticsContext,
    offerSetMetadata: metadata,
    controlledTest: input.controlledTest,
  ...
  instrumentAntiRegretFoundationFromOfferSet(supabase, {
    requestId,
    analyticsContext: input.analyticsContext || bucket.analyticsContext,
    offerSetMetadata: metadata,
    decisionMetadata: getRecommendationDecisionMetadataSnapshot(),
    decisionSummary: getRecommendationDecisionMetadataSnapshot(),
    controlledTest: input.controlledTest,
  });
