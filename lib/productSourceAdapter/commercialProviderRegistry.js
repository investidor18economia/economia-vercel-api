...
export const COMMERCIAL_PROVIDER_REGISTRY_VERSION = "4B.4";

export const MERCADOLIVRE_COMMERCIAL_PROVIDER_ENABLED_ENV =

  "COMMERCIAL_PROVIDER_MERCADOLIVRE_ENABLED";

export const DATAFORSEO_COMMERCIAL_PROVIDER_ENABLED_ENV =

  "COMMERCIAL_PROVIDER_DATAFORSEO_ENABLED";
...
const REGISTRY = Object.freeze([
  ...
  Object.freeze({
    ...
    authEnvKeys: Object.freeze(["DATAFORSEO_LOGIN", "DATAFORSEO_PASSWORD"]),
...
export function isDataForSeoCommercialProviderRuntimeEnabled(env = process.env) {

  const raw = String(env?.[DATAFORSEO_COMMERCIAL_PROVIDER_ENABLED_ENV] || "")
...
function resolveProviderRuntimeEnabled(provider = null, env = process.env) {
  ...
  if (provider.id === COMMERCIAL_PROVIDER_IDS.GOOGLE_SHOPPING_DATAFORSEO) {

    return isDataForSeoCommercialProviderRuntimeEnabled(env);
